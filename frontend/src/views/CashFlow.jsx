...
export default function CashFlow() {
  ...
  return <>
    <PageHeader title="Cash Flow" subtitle="Your dedicated money-in, money-out and all-time passbook" />
