      ...
      {selectedStaff ? <div className="card mt-4">
        ...
        <div className="card-body p-4">
          {editing ? <form className="row g-3" onSubmit={saveDetails}>
            ...
            <div className="col-md-6"><label htmlFor="editStaffRole" className="form-label">Role</label><select id="editStaffRole" className="form-select" value={editForm.role || "staff"} onChange={(event) => setEditForm({ ...editForm, role: event.target.value })}><option value="sales">Sales</option><option value="inventory_staff">Inventory Staff</option></select></div>
