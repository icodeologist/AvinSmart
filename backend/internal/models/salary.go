...
type Salary struct {
	...
	Currency         string       `gorm:"column:currency;type:varchar(3);not null;default:INR" json:"currency"`
	...
	PaidAmount       money.Amount `gorm:"column:paid_amount;type:numeric(12,2);not null;default:0" json:"paid_amount"`
	PaymentMethod    string       `gorm:"column:payment_method;type:varchar(40)" json:"payment_method,omitempty"`
	PaymentReference string       `gorm:"column:payment_reference;type:varchar(120)" json:"payment_reference,omitempty"`
	PaidByID         *uint        `gorm:"column:paid_by_id" json:"paid_by_id,omitempty"`
